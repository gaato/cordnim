...
func classifyVoiceClose*(code: VoiceCloseCode): VoiceCloseDecision {.raises: [].} =
  ...
  of 4014:
    VoiceCloseDecision(action: stopVoiceReconnect, reason: "client disconnected")
  of 4017:
    VoiceCloseDecision(action: stopVoiceReconnect, reason: "DAVE protocol required")
  of 4021:
    VoiceCloseDecision(action: stopVoiceReconnect, reason: "voice rate limit exceeded")
  of 4022:
    VoiceCloseDecision(action: stopVoiceReconnect, reason: "call terminated")
  of 4004:
    VoiceCloseDecision(action: stopVoiceReconnect, reason: "voice authentication failed")
  else:
