...
type
  Permission* {.pure.} = enum
    ## Discord permission bit positions documented on 2026-07-11.
    createInstantInvite = 0 ## Create instant invites.
    kickMembers = 1         ## Kick guild members.
    banMembers = 2          ## Ban guild members.
    administrator = 3       ## Bypass channel overwrites and grant all permissions.
  ...
  Permissions* = DiscordBits[Permission]
    ## Arbitrary-width permission value preserving all unknown bits.
